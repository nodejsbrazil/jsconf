...
export const formTitle =
  'font-[var(--ifm-font-family-title)] text-[3.2rem] max-md:text-[2.6rem] max-sm:text-[2.2rem] font-black text-white leading-[1.2] tracking-tight';

export const sectionHeading =
  'font-[var(--ifm-font-family-title)] text-[2rem] max-sm:text-[1.7rem] font-extrabold text-white leading-[1.3] mt-[0.4rem]';

export const paragraph =
  'text-[1.5rem] font-medium leading-[1.8] text-white/80';

export const strong = 'text-white font-bold';

export const field = 'flex flex-col gap-[0.8rem] mb-[0.8rem]';

export const fieldLabel = 'text-[1.5rem] font-bold text-white leading-[1.4]';

export const required = 'text-required ml-[0.2rem]';

export const subLabel = 'text-[1.3rem] font-medium text-white/50';

export const fieldDescription = 'text-[1.35rem] text-white/60 leading-[1.6]';

export const textInput =
  'w-full rounded-[0.6rem] border border-primary/20 bg-transparent px-[1.4rem] py-[1.1rem] font-[var(--ifm-font-family-base)] text-[1.5rem] text-white outline-none transition-[border-color,box-shadow] duration-200 placeholder:text-white/30 focus:border-primary focus:shadow-[0_0_0_0.25rem_rgba(141,248,34,0.1)]';
...
export const radioOption = (selected: boolean) =>
  `relative flex cursor-pointer items-center gap-[1rem] rounded-[0.6rem] border bg-transparent px-[1.3rem] py-[1rem] text-[1.4rem] font-medium transition-[border-color,background-color,color] duration-150 ${
    selected
...
export const badge = (selected: boolean) =>
  `flex shrink-0 items-center justify-center w-[2.2rem] h-[2.2rem] rounded-[0.4rem] border text-[1.1rem] font-bold transition-[border-color,color] duration-150 ${
    selected
...
export const checkboxGroupLabel =
  'text-[1.4rem] font-bold text-white/80 mt-[1rem] mb-[-0.4rem]';

export const submitButton =
  'flex cursor-pointer items-center justify-center gap-[0.8rem] self-end rounded-[0.75rem] border-none bg-gradient-to-r from-primary-dark to-primary-light px-[2.4rem] py-[1.2rem] font-[var(--ifm-font-family-base)] text-[1.5rem] font-bold text-white shadow-[0.1rem_0.1rem_0.2rem_#071f0dca] transition-transform duration-200 hover:-translate-y-[0.2rem] mt-[1rem]';
